...
export const initialMessages: Message[] = [
  ...
  { 
    ...
    message: "Here's an example of what we can do:\n\n### Styled Lists\n- <span style='color: #646cff'>Colored text</span>\n- **Bold items**\n- *Italic items*\n\n### Code Examples\n```typescript\nconst greeting = 'Hello World!';\nconsole.log(greeting);\n```",
    sender: "me", 
    role: "user",
    name: "User",
    timestamp: "09:17", 
  ...
  { 
    ...
    message: "We can also do tables and quotes:\n\n| Feature | Support |\n|---------|----------|\n| Tables | ✅ |\n| Lists | ✅ |\n| Code | ✅ |\n\n> This is a blockquote with some _emphasized_ text\n\n### Links and Images\nCheck out this [link](https://example.com) 🔗",
    sender: "other", 
    role: "bot",
    name: "Assistant",
    timestamp: "09:20", 
  ...
  { 
    ...
    message: "We can even do keyboard shortcuts:\n\nPress <kbd>Ctrl</kbd> + <kbd>C</kbd> to copy\n\nAnd add some inline code: `const x = 42;`\n\n### Emoji Support\n🚀 🎨 💻 ⚡️",
    sender: "other", 
    role: "bot",
    name: "Assistant",
    timestamp: "09:25", 
