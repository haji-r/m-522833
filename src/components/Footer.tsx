      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-white">ShazBot</h3>
            <p className="text-sm">
              Exploring AI, security, design, technology, and creativity through thoughtful products.
            </p>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-sm text-center">
          <p>&copy; {new Date().getFullYear()} ShazBot. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
