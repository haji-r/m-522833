...
const FEATURED_POST = {
  ...
  excerpt: "Explore how we design our AI systems to evolve and shape the future of digital product development. From atomic design to AI-powered components.",
  image: "https://images.unsplash.com/photo-1498050108023-c5249f4df085",
  author: "Tim Lynar",
  date: "11 March 2025",
  categories: ["AI", "Design Systems", "Technology"],
  slug: "future-of-ai-systems"
};

const BLOG_POSTS = [
  {
    title: "Conversations with Our LLM Tamer",
    excerpt: "We sat down with our prolific LLM trainer and product designer to find out how they've used our platform to 2x their revenue.",
    image: "https://images.unsplash.com/photo-1488590528505-98d2b5aba04b",
    author: "Lisa Liu-Thorrold",
    date: "20 Jan 2025",
    categories: ["Design", "Research"],
    slug: "llm-tamer-conversation"
  },
  {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative bg-primary overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[url('../../../src/assets/images/cityscape.webp')] bg-cover bg-center mix-blend-overlay"></div>
        <div className="relative container mx-auto px-4 py-32">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 text-white leading-tight">
              Secured AI for local business
            </h1>
            <p className="text-xl md:text-2xl mb-12 text-white/90 leading-relaxed">
              Get a secured AI to help your business grow. 
